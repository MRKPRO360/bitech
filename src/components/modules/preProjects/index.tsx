...
import PreProjectCard from './PreProjectCard';

function PreProjects({ projects }: { projects: IPrebuiltProject[] }) {
    ...
    <div className="min-h-screen bg-gray-50 pt-32  pb-20 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <SecondaryHeading className="mb-6">
          Our Prebuilt Projects
        </SecondaryHeading>
        <Para>
          Explore our collection of innovative prebuilt projects, designed to
          accelerate your development and inspire your next big idea. Each
          project is a testament to our expertise and commitment to quality.
        </Para>
      </div>
      <Container>
        {/* PreProjects Grid */}
        ...
        >
          {projects.map((project) => (
            <PreProjectCard key={project._id} project={project} />
          ))}
        </div>
