...
function TailorManagementHeading() {
  return (
    <section
      //   ref={heroRef}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <Para className="mb-8 text-white">
              Designed for modern tailoring shops to manage orders, customers,
              and deliveries with ease. Focus on creativity — let the system
              handle operations.
            </Para>
...
export default TailorManagementHeading;
