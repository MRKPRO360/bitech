        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              <h1>Smart POS Management Software</h1>
            </h1>
            <Para className="mb-8 text-white">
              Simplify sales, manage inventory, and analyze business growth with
              our modern POS system designed for retail and restaurant
              businesses.
            </Para>
...
export default PosManagementHeading;
