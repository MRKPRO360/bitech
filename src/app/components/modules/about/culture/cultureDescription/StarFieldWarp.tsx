...
const StarfieldWarp: React.FC<StarfieldWarpProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // White spotlight effect instead of blue
      if (warpSpeedRef.current > 1) {
        ...
        gradient.addColorStop(
          0,
          `rgba(255,255,255,${warpSpeedRef.current * 0.05})`
        );
  ...
  return (
    <div
      ref={wrapperRef}
      className="relative w-full min-h-[500px] flex items-center justify-center flex-col overflow-hidden rounded-high"
    >
